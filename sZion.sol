...
contract sZion is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Zion", "sZION", 9) ERC20Permit() {
    ...
    /**
        @notice increases sZION supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sZION
